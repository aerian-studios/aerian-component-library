...
export const CustomHeadingLevel = () => (
	<AerAccordion.Root type="multiple">
		<AerAccordion.Item value="item-1">
			<AerAccordion.Header headingLevel="h2" style={{display: "grid", gridTemplateColumns: "1fr max-content", gridTemplateRows: "auto", gap: "var(--s-1)", height: "auto"}}>
        <span style={{display: "flex", gap: "var(--s-2)", gridColumn: "1", gridRow: "1"}}><MoonIcon style={{transform: "scale(2.5)", color: "yellowgreen"}} /><span>Header 1</span></span><span style={{fontSize: "var(--t-body-s)", color: "var(--c-gray-600",gridRow:"2"}}>This is some other content inside the `h2 > button` (phrasing content)</span></AerAccordion.Header>
			<AerAccordion.Content>
